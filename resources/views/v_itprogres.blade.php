...
<body>
    ...
    @else
    <div style="position:relative;width: 400px;margin:0 auto;border-style: solid;border-color:burlywood;border-radius:5px   ">
        <div class="momo" style="padding: 10px;">
            <div style="height:50px;line-height:50px;text-align:center;background-color:blueviolet;border-radius:5px; font-size:0.8cm">
                IT BINUS BEKASI
            </div>
            ...
            <form style="margin-top: 5px;" id="form-add">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="id_ticket" value="{{$ticket->id_ticket}}" disabled>
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Ruangan</label>
                    <input type="text" class="form-control" id="ruangan" value="{{$ticket->nama_ruangan}}" disabled>
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Masalah</label>
                    <input type="text" class="form-control" id="problem" value="{{$ticket->problem}}" disabled>
                </div>
                <div class="form-group">
                    <label for="exampleFormControlSelect1">Status Ticket</label>
            ...
            <button type="button" class="btn btn-secondary" onclick="document.getElementById('form-add').reset();">Close</button>

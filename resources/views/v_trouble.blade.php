...
<html lang="en">
    ...
    <body>
        <div class="container-form">
            <div style="width: 100%">
                <img
                    src="/image/garisbiru.png"
                    style="margin-left: 250px; display: ruby-text"
                    width="40px"
                    height="90px"
                    alt=""
                />
                <img
                    src="/image/logo-binus.png"
                ...
                <div class="options-container">
                    ...
                    <div class="option">
                        <input
                            type="radio"
                            class="radio"
                            value="{{$kerus->id_kerusakan}}"
                            id="internet"
                            name="category"
                        />
                        <label
                            for="internet"
                            >{{$kerus->jenis_kerusakan}}</label
                        >
                    </div>
                    @endforeach
                </div>
                    ...
                    <li>
                        <div class="grey">
                            <div class="img-handler-top">
                                <img
                                    id="img-search"
                                    src="/image/search-grey.png"
                                    alt=""
                                />
                            </div>
                            <div id="text-search" class="ps-bot-search">
                                Mencari Teknisi
                            </div>

                            <span id="span-search" class="ps-sp-top grey"
                                >1</span
                            >
                        </div>
                    </li>

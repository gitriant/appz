      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form" id="form-add">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="control-group">
                <label class="control-label">Nama IT</label>
                <div class="controls">
                  <input class="form-control" type="text" id="nama" placeholder="Type something here..." class="span15">
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="control-group">
                ...
                <div class="controls">
                  <input class="form-control" type="text" id="email" placeholder="Type something here..." class="span15">
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="control-group">
                ...
                <div class="controls">
                  <input class="form-control" type="text" id="username" placeholder="Type something here..." class="span15">
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="control-group">
                ...
                <div class="controls">
                  <input class="form-control" type="password" id="password" placeholder="Type something here..." class="span15">
                </div>
              </div>
            </div>
          </div>
          <div class="control-group">
            ...
            <div class="controls">
              <input class="form-control" type="text" id="level" placeholder="Type something here..." class="span15">
            </div>
          </div>
